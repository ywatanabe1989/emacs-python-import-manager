...
;;; Author: 2025-01-22 21:49:27
;;; Timestamp: <2025-01-22 21:49:27>
...
(defvar pim-imports-data-science
  '(
    ...
    ("ClusterCentroids" . "from imblearn.under_sampling import ClusterCentroids")
    ...
    ("LocalOutlierFactor" . "from sklearn.neighbors import LocalOutlierFactor")
    ...
    ("TimeSeriesSplit" . "from sklearn.model_selection import TimeSeriesSplit")
    ("GroupKFold" . "from sklearn.model_selection import GroupKFold")
    ("learning_curve" . "from sklearn.model_selection import learning_curve")
    ("validation_curve" . "from sklearn.model_selection import validation_curve")
    ("permutation_test_score" . "from sklearn.model_selection import permutation_test_score")
    ...
    ("mean_squared_log_error" . "from sklearn.metrics import mean_squared_log_error")
    ("median_absolute_error" . "from sklearn.metrics import median_absolute_error")
    ("explained_variance_score" . "from sklearn.metrics import explained_variance_score")
    ...
    ("mean_poisson_deviance" . "from sklearn.metrics import mean_poisson_deviance")
    ("mean_gamma_deviance" . "from sklearn.metrics import mean_gamma_deviance")
    ("mean_tweedie_deviance" . "from sklearn.metrics import mean_tweedie_deviance")
    ("d2_absolute_error_score" . "from sklearn.metrics import d2_absolute_error_score")
    ("d2_pinball_score" . "from sklearn.metrics import d2_pinball_score")
    ("d2_tweedie_score" . "from sklearn.metrics import d2_tweedie_score")
    ...
    ("matthews_corrcoef" . "from sklearn.metrics import matthews_corrcoef")
    ...
    ("brier_score_loss" . "from sklearn.metrics import brier_score_loss")

    ;; ROC and PR Curves
    ("roc_curve" . "from sklearn.metrics import roc_curve")
    ("auc" . "from sklearn.metrics import auc")
    ("average_precision_score" . "from sklearn.metrics import average_precision_score")
    ("det_curve" . "from sklearn.metrics import det_curve")

    ;; Multilabel Metrics
    ("multilabel_confusion_matrix" . "from sklearn.metrics import multilabel_confusion_matrix")
    ("coverage_error" . "from sklearn.metrics import coverage_error")
    ("label_ranking_average_precision_score" . "from sklearn.metrics import label_ranking_average_precision_score")
    ("label_ranking_loss" . "from sklearn.metrics import label_ranking_loss")
    ...
    ("IterativeImputer" . "from sklearn.impute import IterativeImputer")
    ...
    ("RepeatedStratifiedKFold" . "from sklearn.model_selection import RepeatedStratifiedKFold")
    ...
    ("GroupShuffleSplit" . "from sklearn.model_selection import GroupShuffleSplit")
    ("LeaveOneGroupOut" . "from sklearn.model_selection import LeaveOneGroupOut")
    ("LeavePGroupsOut" . "from sklearn.model_selection import LeavePGroupsOut")
    ("PredefinedSplit" . "from sklearn.model_selection import PredefinedSplit")
    ...
    ("DataCollatorWithPadding" . "from transformers import DataCollatorWithPadding")
    ("EarlyStopping" . "from pytorch_lightning.callbacks import EarlyStopping")
    ("ModelCheckpoint" . "from pytorch_lightning.callbacks import ModelCheckpoint")
    ...
    ;; Vision Transformers
    ("ViTFeatureExtractor" . "from transformers import ViTFeatureExtractor")
    ("ViTImageProcessor" . "from transformers import ViTImageProcessor")
